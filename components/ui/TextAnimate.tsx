...
> = {
  ...
  scaleUp: {
    ...
    item: {
      ...
      exit: { scale: 0.5, opacity: 0, transition: { duration: 0.3, scale: { type: "spring", damping: 15, stiffness: 300 } } },
    },
  },
  scaleDown: {
    container: defaultContainerVariants,
    item: {
      ...
      show: { scale: 1, opacity: 1, transition: { duration: 0.3, scale: { type: "spring", damping: 15, stiffness: 300 } } },
      exit: { scale: 1.5, opacity: 0, transition: { duration: 0.3, scale: { type: "spring", damping: 15, stiffness: 300 } } },
    },
  },
};
